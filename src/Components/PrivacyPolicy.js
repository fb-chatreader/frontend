  ...
  return (
    <div className='privacy-container'>
      ...
      <p>
        ...
        carefully before using Chat Reader (the "Service") operated by Chat
        reader ("us", "we", or "our").
      </p>
      ...
      <p>
        ...
        Service. The Terms of Service agreement for Chat reader has been created
        with the help of <a href='https://www.termsfeed.com/'>TermsFeed</a>.
      </p>
      ...
      <p>
        ...
        are not owned or controlled by Chat reader.
      </p>

      <p>
        Chat reader has no control over and assumes no responsibility for, the
        content, privacy policies, or practices of any third-party web sites or
        services. You further acknowledge and agree that Chat reader shall not
      ...
      <p>
        These Terms shall be governed and construed by the laws of California,
      ...
      <p>
        ...
        Terms at any time. If a revision is a material we will try to provide at
        least 30 days' notice before any new terms taking effect. What
